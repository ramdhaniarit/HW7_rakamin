...
const dataLog = ` 03/22 08:54:24 INFO   :......rsvp_flow_stateMachine: state RESVED, event T1OUT
...
`
// write
fs.writeFile('logging.txt', dataLog, (err, data) => {
    if (err) { console.log(err)};

    console.log("data berahsil ditulis")
})
// read
